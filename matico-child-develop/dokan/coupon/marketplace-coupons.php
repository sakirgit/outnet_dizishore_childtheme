    ...
    foreach ( $coupons as $coupon ) {
        ...
        ?>
            <tr class="tr-collapse">
                <td class="coupon-code column-primary td-mobile-head" data-title="<?php esc_attr_e( 'Code', 'dokan' ); ?>">
                    ...
                    <div class="td-head-mobile dokan-hide">
                        <div class="coupon-type">
                            <span><?php echo esc_html( $types[ $discount_type ] ); ?></span> : <?php echo esc_attr( wc_format_localized_price( $wc_coupon->get_amount() ) ); ?>
                        </div>
                ...
                <td data-title="<?php esc_attr_e( 'Coupon type', 'dokan' ); ?>">
                    <?php echo esc_html( $types[ $discount_type ] ); ?>
                </td>
