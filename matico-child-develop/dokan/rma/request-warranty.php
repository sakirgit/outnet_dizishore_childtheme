            ...
            <tbody>
                <?php foreach ( $order->get_items( 'line_item' ) as $item ) : ?>
                    ...
                    <tr>
                        ...
                        <td data-title="<?php esc_attr_e( 'Product Name', 'dokan' ); ?>"><a href="<?php echo esc_url( $_product->get_permalink() ); ?>"><?php echo esc_html( $_product->get_title() ); ?></a></td>
                        <td data-title="<?php esc_attr_e( 'Price', 'dokan' ); ?>"><?php echo $_product->get_price_html(); ?></td>
                        <td data-title="<?php esc_attr_e( 'Vendor', 'dokan' ); ?>">
                            <?php
                        ...
                        <td data-title="<?php esc_attr_e( 'Warranty Details', 'dokan' ); ?>">
                            <?php
