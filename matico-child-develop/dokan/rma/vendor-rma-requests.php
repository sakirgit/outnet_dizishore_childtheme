                            ...
                            <?php if ( $requests ) { ?>
                                <?php foreach ( $requests as $request ) { ?>
                                    <tr class="tr-collapse">
                                        <td class="details column-primary td-mobile-head vendor-rma-request-td">
                                            <div>
                                                <?php
                                            ...
                                            <div class="row-action-status">
                                                ...
                                                <div class="td-head-mobile dokan-hide">
                                                    <?php _e( 'Status: ', 'dokan' ); ?><?php echo dokan_warranty_request_status( $request['status'] ); ?>
                                                    <span class="matico-icon"></span>
                                                </div>
                                                <div class="td-mb-date dokan-hide">
