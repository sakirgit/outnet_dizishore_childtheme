...
<div class="u-columns col2-set" id="customer_login">
    ...
    <div class="u-column1 login-form-col col-1 woo-login-form <?php echo isset($_GET['action']) && 'register' === $_GET['action'] ? 'deactive' : ''; ?>">
    ...
    <div class="mobile-phone-register-wrapper register-now-trigger <?php echo isset($_GET['action']) && 'register' === $_GET['action'] ? 'deactive' : ''; ?>">
        <div class="mb-divider-login">
            <span><?php echo esc_html__("Don't have an account?", "matico"); ?></span>
        </div>
        <a class="woocommerce-button button woocommerce-form-login__submit" href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>?action=register"><?php echo esc_html__("Create Your Account", "matico"); ?></a>
    </div>

    <div class="u-column2 col-2 woo-register-form <?php echo isset($_GET['action']) && 'register' === $_GET['action'] ? 'active' : ''; ?>">
    ...
    <div class="mobile-phone-register-wrapper login-now-trigger <?php echo isset($_GET['action']) && 'register' === $_GET['action'] ? 'active' : ''; ?>">
        <div class="mb-divider-login">
            <span><?php echo esc_html__("Already have an account?", "matico"); ?></span>
        </div>
        <a class="woocommerce-button button woocommerce-form-login__submit" href="<?php echo get_permalink( wc_get_page_id( 'myaccount' ) ); ?>?action=login"><?php echo esc_html__("Login Now", "matico"); ?></a>
    </div>
</div>
<?php endif; ?>
