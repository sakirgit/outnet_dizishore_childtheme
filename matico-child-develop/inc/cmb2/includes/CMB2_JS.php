...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'matico-child' ),
			'defaultString' => esc_html__( 'Default', 'matico-child' ),
			'pick'          => esc_html__( 'Select Color', 'matico-child' ),
			'current'       => esc_html__( 'Current Color', 'matico-child' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'matico-child' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'matico-child' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'matico-child' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'matico-child' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'matico-child' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'matico-child' ) ),
					'nextText'        => esc_html__( 'Next', 'matico-child' ),
					'prevText'        => esc_html__( 'Prev', 'matico-child' ),
					'currentText'     => esc_html__( 'Today', 'matico-child' ),
					'closeText'       => esc_html__( 'Done', 'matico-child' ),
					'clearText'       => esc_html__( 'Clear', 'matico-child' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'matico-child' ),
					'timeText'      => esc_html__( 'Time', 'matico-child' ),
					'hourText'      => esc_html__( 'Hour', 'matico-child' ),
					'minuteText'    => esc_html__( 'Minute', 'matico-child' ),
					'secondText'    => esc_html__( 'Second', 'matico-child' ),
					'currentText'   => esc_html__( 'Now', 'matico-child' ),
					'closeText'     => esc_html__( 'Done', 'matico-child' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'matico-child' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'matico-child' ),
				'upload_files' => esc_html__( 'Use these files', 'matico-child' ),
				'remove_image' => esc_html__( 'Remove Image', 'matico-child' ),
				'remove_file'  => esc_html__( 'Remove', 'matico-child' ),
				'file'         => esc_html__( 'File:', 'matico-child' ),
				'download'     => esc_html__( 'Download', 'matico-child' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'matico-child' ),
			),
		);
