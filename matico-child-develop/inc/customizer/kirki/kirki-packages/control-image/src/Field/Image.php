	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['settings'] === $this->args['settings'] ) {
			...
			$args['button_labels'] = wp_parse_args(
				$args['button_labels'],
				[
					'select'       => esc_html__( 'Select image', 'matico-child' ),
					'change'       => esc_html__( 'Change image', 'matico-child' ),
					'default'      => esc_html__( 'Default', 'matico-child' ),
					'remove'       => esc_html__( 'Remove', 'matico-child' ),
					'placeholder'  => esc_html__( 'No image selected', 'matico-child' ),
					'frame_title'  => esc_html__( 'Select image', 'matico-child' ),
					'frame_button' => esc_html__( 'Choose image', 'matico-child' ),
				]
			);
