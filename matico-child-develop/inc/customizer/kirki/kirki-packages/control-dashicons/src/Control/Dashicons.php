		...
		<div class="icons-wrapper">
			...
			<# } else { #>
				...
				var dashiconSections = {
					'admin-menu': '<?php esc_html_e( 'Admin Menu', 'matico-child' ); ?>',
					'welcome-screen': '<?php esc_html_e( 'Welcome Screen', 'matico-child' ); ?>',
					'post-formats': '<?php esc_html_e( 'Post Formats', 'matico-child' ); ?>',
					'media': '<?php esc_html_e( 'Media', 'matico-child' ); ?>',
					'image-editing': '<?php esc_html_e( 'Image Editing', 'matico-child' ); ?>',
					'tinymce': 'TinyMCE',
					'posts': '<?php esc_html_e( 'Posts', 'matico-child' ); ?>',
					'sorting': '<?php esc_html_e( 'Sorting', 'matico-child' ); ?>',
					'social': '<?php esc_html_e( 'Social', 'matico-child' ); ?>',
					'wordpress_org': 'WordPress',
					'products': '<?php esc_html_e( 'Products', 'matico-child' ); ?>',
					'taxonomies': '<?php esc_html_e( 'Taxonomies', 'matico-child' ); ?>',
					'widgets': '<?php esc_html_e( 'Widgets', 'matico-child' ); ?>',
					'notifications': '<?php esc_html_e( 'Notifications', 'matico-child' ); ?>',
					'misc': '<?php esc_html_e( 'Miscelaneous', 'matico-child' ); ?>'
				};
				#>
