...
class Typography extends Field {
	...
	public function init( $args = [] ) {
		...
		self::$std_variants = [
			[
				'value' => 'regular',
				'label' => __( 'Regular', 'matico-child' ),
			],
			[
				'value' => 'italic',
				'label' => __( 'Italic', 'matico-child' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'matico-child' ),
			],
			[
				'value' => '700italic',
				'label' => __( '700 Italic', 'matico-child' ),
			],
		];
		...
		self::$complete_variants = [
			...
			[
				'value' => '100',
				'label' => __( '100', 'matico-child' ),
			],
			[
				'value' => '100italic',
				'label' => __( '100 Italic', 'matico-child' ),
			],
			[
				'value' => '200',
				'label' => __( '200', 'matico-child' ),
			],
			[
				'value' => '200italic',
				'label' => __( '200 Italic', 'matico-child' ),
			],
			[
				'value' => '300',
				'label' => __( '300', 'matico-child' ),
			],
			[
				'value' => '300italic',
				'label' => __( '300 Italic', 'matico-child' ),
			],
			[
				'value' => '500',
				'label' => __( '500', 'matico-child' ),
			],
			[
				'value' => '500italic',
				'label' => __( '500 Italic', 'matico-child' ),
			],
			[
				'value' => '600',
				'label' => __( '600', 'matico-child' ),
			],
			[
				'value' => '600italic',
				'label' => __( '600 Italic', 'matico-child' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'matico-child' ),
			...
			[
				'value' => '800',
				'label' => __( '800', 'matico-child' ),
			],
			[
				'value' => '800italic',
				'label' => __( '800 Italic', 'matico-child' ),
			],
			[
				'value' => '900',
				'label' => __( '900', 'matico-child' ),
			],
			[
				'value' => '900italic',
				'label' => __( '900 Italic', 'matico-child' ),
			],
		];
	...
	private function add_sub_fields( $args ) {
		...
		if ( isset( $args['default']['font-family'] ) ) {
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Family', 'matico-child' ),
						'description' => '',
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Variant', 'matico-child' ),
						'description' => '',
		...
		if ( $font_size_field_specified || $color_field_specified ) {
			$group = [
				'font-size' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Font Size', 'matico-child' ),
					'is_specified' => $font_size_field_specified,
				],
				'color'     => [
					'type'         => 'react-colorful',
					'label'        => esc_html__( 'Font Color', 'matico-child' ),
		...
		if ( $text_align_field_specified || $text_transform_field_specified ) {
			$group = [
				'text-align'     => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Align', 'matico-child' ),
					'is_specified' => $text_align_field_specified,
					'choices'      => [
						'initial' => esc_html__( 'Initial', 'matico-child' ),
						'left'    => esc_html__( 'Left', 'matico-child' ),
						'center'  => esc_html__( 'Center', 'matico-child' ),
						'right'   => esc_html__( 'Right', 'matico-child' ),
						'justify' => esc_html__( 'Justify', 'matico-child' ),
					],
				],
				'text-transform' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Transform', 'matico-child' ),
					'is_specified' => $text_transform_field_specified,
					'choices'      => [
						'none'       => esc_html__( 'None', 'matico-child' ),
						'capitalize' => esc_html__( 'Capitalize', 'matico-child' ),
						'uppercase'  => esc_html__( 'Uppercase', 'matico-child' ),
						'lowercase'  => esc_html__( 'Lowercase', 'matico-child' ),
					],
				],
			];
		...
		if ( $text_decoration_field_specified ) {
			$group = [
				'text-decoration' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Decoration', 'matico-child' ),
					'is_specified' => $text_decoration_field_specified,
					'choices'      => [
						'none'         => esc_html__( 'None', 'matico-child' ),
						'underline'    => esc_html__( 'Underline', 'matico-child' ),
						'line-through' => esc_html__( 'Line Through', 'matico-child' ),
						'overline'     => esc_html__( 'Overline', 'matico-child' ),
						'solid'        => esc_html__( 'Solid', 'matico-child' ),
						'wavy'         => esc_html__( 'Wavy', 'matico-child' ),
					],
				],
			];
		...
		if ( $line_height_field_specified || $letter_spacing_field_specified ) {
			$group = [
				'line-height'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Line Height', 'matico-child' ),
					'is_specified' => $line_height_field_specified,
				],
				'letter-spacing' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Letter Spacing', 'matico-child' ),
		...
		if ( $margin_top_field_specified || $margin_bottom_field_specified ) {
			$group = [
				'margin-top'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Top', 'matico-child' ),
					'is_specified' => $margin_top_field_specified,
				],
				'margin-bottom' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Bottom', 'matico-child' ),
	...
	private function get_font_family_choices() {
		...
		$choices['default'] = [
			esc_html__( 'Defaults', 'matico-child' ),
			[
				'' => esc_html__( 'Default', 'matico-child' ),
			],
		];
		...
		$choices['standard'] = [
			esc_html__( 'Standard Fonts', 'matico-child' ),
			$std_fonts,
		];

		$choices['google'] = [
			esc_html__( 'Google Fonts', 'matico-child' ),
