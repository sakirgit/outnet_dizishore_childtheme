		...
		new \Kirki\Field\Color(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Color', 'matico-child' ),
		...
		new \Kirki\Field\Image(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Image', 'matico-child' ),
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Repeat', 'matico-child' ),
					'section'     => $args['section'],
					'default'     => isset( $args['default']['background-repeat'] ) ? $args['default']['background-repeat'] : '',
					'choices'     => [
						'no-repeat' => esc_html__( 'No Repeat', 'matico-child' ),
						'repeat'    => esc_html__( 'Repeat All', 'matico-child' ),
						'repeat-x'  => esc_html__( 'Repeat Horizontally', 'matico-child' ),
						'repeat-y'  => esc_html__( 'Repeat Vertically', 'matico-child' ),
					],
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Position', 'matico-child' ),
					'default'     => isset( $args['default']['background-position'] ) ? $args['default']['background-position'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'left top'      => esc_html__( 'Left Top', 'matico-child' ),
						'left center'   => esc_html__( 'Left Center', 'matico-child' ),
						'left bottom'   => esc_html__( 'Left Bottom', 'matico-child' ),
						'center top'    => esc_html__( 'Center Top', 'matico-child' ),
						'center center' => esc_html__( 'Center Center', 'matico-child' ),
						'center bottom' => esc_html__( 'Center Bottom', 'matico-child' ),
						'right top'     => esc_html__( 'Right Top', 'matico-child' ),
						'right center'  => esc_html__( 'Right Center', 'matico-child' ),
						'right bottom'  => esc_html__( 'Right Bottom', 'matico-child' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Size', 'matico-child' ),
					'default'     => isset( $args['default']['background-size'] ) ? $args['default']['background-size'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'cover'   => esc_html__( 'Cover', 'matico-child' ),
						'contain' => esc_html__( 'Contain', 'matico-child' ),
						'auto'    => esc_html__( 'Auto', 'matico-child' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'description' => esc_html__( 'Background Attachment', 'matico-child' ),
					'label'       => '',
					'default'     => isset( $args['default']['background-attachment'] ) ? $args['default']['background-attachment'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'scroll' => esc_html__( 'Scroll', 'matico-child' ),
						'fixed'  => esc_html__( 'Fixed', 'matico-child' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
