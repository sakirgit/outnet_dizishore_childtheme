...
class Dimensions extends Field {
	...
	public function init( $args = array() ) {
		...
		$labels = array(
			...
			'font-size'      => esc_html__( 'Font Size', 'matico-child' ),
			'font-weight'    => esc_html__( 'Font Weight', 'matico-child' ),
			'line-height'    => esc_html__( 'Line Height', 'matico-child' ),
			'font-style'     => esc_html__( 'Font Style', 'matico-child' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'matico-child' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'matico-child' ),
			'top'            => esc_html__( 'Top', 'matico-child' ),
			'bottom'         => esc_html__( 'Bottom', 'matico-child' ),
			'left'           => esc_html__( 'Left', 'matico-child' ),
			'right'          => esc_html__( 'Right', 'matico-child' ),
			'center'         => esc_html__( 'Center', 'matico-child' ),
			'size'           => esc_html__( 'Size', 'matico-child' ),
			'spacing'        => esc_html__( 'Spacing', 'matico-child' ),
			'width'          => esc_html__( 'Width', 'matico-child' ),
			'height'         => esc_html__( 'Height', 'matico-child' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'matico-child' ),
		);
