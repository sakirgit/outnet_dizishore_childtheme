...
class SetupSettings {
	...
	public function submenu_page() {
		...
		add_submenu_page(
			'options-general.php',
			__( 'Kirki Customizer Framework', 'matico-child' ),
			__( 'Kirki', 'matico-child' ),
	...
	public function clear_font_cache() {
		...
		if ( is_dir( $fonts_dir ) ) {
			...
			wp_send_json_error( 'No local fonts found.', 'matico-child' );
		}

		wp_send_json_success( 'Font cache cleared.', 'matico-child' );
