...
class Elementor_DiziShore_First_Para_Ads_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return 'dizishore_blog_after_first_para_ads_widget';
    }

    public function get_title() {
        return esc_html__('DiziShore Blog Ads After 1st Para', 'matico-child');
    }
